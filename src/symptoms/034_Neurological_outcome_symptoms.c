#include "034_Neurological_outcome_symptoms.h"

enum Triage_Level
get_symptoms_neurological_triage(struct Neurological Neurological) {
  ...
  bool yellow = Neurological.strength_reduction == NS_Ceased_symptoms ||
