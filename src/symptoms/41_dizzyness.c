...
enum Triage_Level get_symptoms_dizzy_triage(struct Dizzy dizzy) {
    ...
    bool orange = dizzy.urgentNeurologicalOutcomes == UNC_language_or_vision_disturbance_24h||
            dizzy.duration == DUR_less_than_24h ||
            dizzy.suspected_poisoning == true ||
            dizzy.fainting == FA_multiple_times ||
            dizzy.painScaleAboveOrEqual5Yr == PAS5_NRS_VAS_4_TO_10_and_yellow_VP_and_affected_cond ||
    ...
    bool yellow = dizzy.urgentNeurologicalOutcomes == UNC_ceased_strength_language_or_vision_disturbance_24h||
                  dizzy.fainting == FA_one_fainting_within_24h ||
                  dizzy.painScaleAboveOrEqual5Yr == PAS5_NRS_VAS_4_TO_10_and_green_VP_and_unaffected_cond ||
    ...
    bool green = dizzy.duration == DUR_more_than_24h||
            dizzy.painScaleAboveOrEqual5Yr == PAS5_NRS_VAS_0_3_and_green_VP_and_unaffected_cond ||
