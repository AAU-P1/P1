...
enum Triage_Level get_symptoms_back_and_neck_triage(struct Back_and_neck back_and_neck){
    ...
    bool orange =
                ...
                back_and_neck.painscaleAboveOrEqual5Yr == PASC5_NRS_VAS_4_TO_10_and_yellow_VP_and_affected_cond ||
                ...
                back_and_neck.nerveInfluence == NI_decreased_feel_in_abdomen_or_urinary_retention;


    bool yellow =
            back_and_neck.trauma == TR_suspected_fracture_without_neuro_symptoms ||
            back_and_neck.painscaleAboveOrEqual5Yr == PASC5_NRS_VAS_4_TO_10_and_green_VP_and_unaffected_cond ||
    ...
    bool green =
            back_and_neck.trauma == TR_urgent_injury_no_fracture ||
            back_and_neck.painscaleAboveOrEqual5Yr == PASC5_NRS_VAS_0_3_and_green_VP_and_unaffected_cond ||
